<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <li class="menu-item {{ request()->is('/admin-area') ? 'active' : '' }}">
            <a href="{{ url('/admin-area') }}" class="menu-link">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Manajemen Inventaris</span>
        </li>

        <li class="menu-item {{ request()->is('barang*') ? 'active' : '' }}">
            <a href="{{ url('/admin-area/barang') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->is('kategori*') ? 'active' : '' }}">
            <a href="{{ url('/admin-area/kategori') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->is('history*') ? 'active' : '' }}">
            <a href="{{ route('transfer.history') }}" class="menu-link">
                ...
                <div>Riwayat Barang</div>
            </a>
        </li>


        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Manajemen Lokasi</span>
        </li>

        <li class="menu-item {{ request()->is('lokasi*') ? 'active' : '' }}">
            <a href="{{ url('/admin-area/lokasi') }}" class="menu-link">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Pengguna & Laporan</span>
        </li>

        <li class="menu-item {{ request()->is('pengguna*') ? 'active' : '' }}">
            <a href="{{ url('/admin-area/pengguna') }}" class="menu-link">
